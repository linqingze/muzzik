...
-(void)setup{
    ...
    _musicPlayView = [[UIView alloc] initWithFrame:CGRectMake(0, 75, SCREEN_WIDTH-2*innerWidth, (int)145+SCREEN_WIDTH*3/4)];
    [_innerView addSubview:_musicPlayView];
    _progress = [[UIProgressView alloc] initWithFrame:CGRectMake(16-innerWidth, 0, SCREEN_WIDTH-32, 0.5)];
    ...
    _poImage = [[UIImageView alloc] initWithFrame:CGRectMake((int)SCREEN_WIDTH/8-innerWidth, 60, (int)SCREEN_WIDTH*3/4, (int)SCREEN_WIDTH*3/4)];
    ...
    _reposts = [[UIButton alloc] initWithFrame:CGRectMake((int)(SCREEN_WIDTH)/8.0-innerWidth, (int)SCREEN_WIDTH*3/4+60, (int)(SCREEN_WIDTH*3)/16.0, 40)];
    ...
    _moves = [[UIButton alloc] initWithFrame:CGRectMake((int)(SCREEN_WIDTH*5)/16.0-innerWidth, (int)SCREEN_WIDTH*3/4+60, (int)(SCREEN_WIDTH*3)/16.0, 40)];
    ...
    _shares = [[UIButton alloc] initWithFrame:CGRectMake((int)SCREEN_WIDTH/2-innerWidth, (int)SCREEN_WIDTH*3/4+60, (int)(SCREEN_WIDTH*3)/16.0, 40)];
    ...
    _comments = [[UIButton alloc] initWithFrame:CGRectMake((int)(SCREEN_WIDTH*11)/16.0-innerWidth, (int)SCREEN_WIDTH*3/4+60, (int)(SCREEN_WIDTH*3)/16.0, 40)];
    ...
    _downLine = [[UIImageView alloc] initWithFrame:CGRectMake((int)SCREEN_WIDTH/8-innerWidth,SCREEN_WIDTH*3/4+ 100, SCREEN_WIDTH*3/4, 1)];
    [_downLine setImage:[UIImage imageNamed:Image_lineImage]];
    [_musicPlayView addSubview:_downLine];
    
    _repostButton = [[UIButton alloc] initWithFrame:CGRectMake((int)SCREEN_WIDTH/8-innerWidth,(int)SCREEN_WIDTH*3/4+100, (int)SCREEN_WIDTH/4.0, 45)];
    ...
    _shareButton = [[UIButton alloc] initWithFrame:CGRectMake((int)SCREEN_WIDTH*3/8-innerWidth,(int)SCREEN_WIDTH*3/4+100,(int) SCREEN_WIDTH/4.0, 45)];
    ...
    _commentButton = [[UIButton alloc] initWithFrame:CGRectMake((int)SCREEN_WIDTH*5/8-innerWidth,(int)SCREEN_WIDTH*3/4+100, (int)SCREEN_WIDTH/4.0, 45)];
