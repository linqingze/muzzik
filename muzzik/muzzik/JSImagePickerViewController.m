...
- (void)imagePickerViewSetup {
    ...
    UIFont *btnFont = [UIFont systemFontOfSize:19.0f];
    
    self.photoLibraryBtn = [[UIButton alloc] initWithFrame:libraryBtnFrame];
    [self.photoLibraryBtn setTitle:@"相册选取" forState:UIControlStateNormal];
    ...
    [self.cameraBtn setTitle:@"拍 照" forState:UIControlStateNormal];
    ...
    for (UIButton *btn in @[self.photoLibraryBtn, self.cameraBtn, self.cancelBtn]) {
        ...
        [btn setTitleColor:Color_Text_3 forState:UIControlStateHighlighted];
    }
    ...
    UIView *separator2 = [[UIView alloc] initWithFrame:CGRectMake(25, 187, screenWidth-50, 1)];
    separator2.backgroundColor = UIColorFromRGB(0xDDDDDD);
    [self.imagePickerView addSubview:separator2];
    UIView *separator3 = [[UIView alloc] initWithFrame:CGRectMake(25, 234, screenWidth-50, 1)];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageWithCGImage:[asset aspectRatioThumbnail]]];
    [imageView setFrame:CGRectMake(0, 2, 110, 110)];
