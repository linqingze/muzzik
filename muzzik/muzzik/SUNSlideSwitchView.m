...
{
    UIView *buttomline = [[UIView alloc] initWithFrame:CGRectMake(kWidthOfButtonMargin, kHeightOfTopScrollView-2, SCREEN_WIDTH-2*kWidthOfButtonMargin, 2)];
    [buttomline setBackgroundColor:Color_line_1];
...
//                                   lineBreakMode:NSLineBreakByTruncatingTail];
        ...
        if (i<[_viewArray count]-1) {
            UIView *middleLine = [[UIView alloc] initWithFrame:CGRectMake(xOffset-1, 8, 1, kHeightOfTopScrollView-16)];
            [middleLine setBackgroundColor:Color_line_1];
            [_topScrollView addSubview:middleLine];
        }
